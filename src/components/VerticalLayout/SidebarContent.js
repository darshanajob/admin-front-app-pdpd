  ...
  return (
    <React.Fragment>
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          {/* Peo Eye Admin Panel menu*/}
          <ul className="metismenu list-unstyled" id="side-menu">
            {/*<li className="menu-title">{userRole} </li>
            <li className="menu-title">{props.t("Menu")} </li>*/}
            <h4 className=" menu-title mb-sm-0 font-size-17">
              {userRole ==='normal-admins'?'Admin' : userRole}</h4>
            <li>
              ...
              <ul className="sub-menu">
                {userRole === "super-admin" && (
                  <li>
                    <Link to="/admin-register">{props.t("Admins")}</Link>
                  </li>
                )}
                <li>
                  <Link to="/list-agents">{props.t("Agents")}</Link>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/student-management">{props.t("Student Management")}</Link>
                </li>
                {userRole !== "agent" && (
                  <>
                    <li>
                      <Link to="/student-table">{props.t("Student Registration Table")}</Link>
                    </li>
                    <li>
                      <Link to="/allocate-agent">{props.t("Students Allocate to Agent")}</Link>
                    </li>
                  </>
                )}
                {userRole === "super-admin" && (
                  <li>
                    <Link to="/course-links">{props.t("Course Link Management")}</Link>
                  </li>
                )}
            ...
            {userRole === "super-admin" && (
              <li>
                ...
                <ul className="sub-menu">
                  <li>
                    <Link to="/paymentlist">{props.t("Payment Approval")}</Link>
                  </li>
                </ul>
              </li>
            )}
            {userRole === "super-admin" && (
              <li>
                <Link to="/#" className="has-arrow">
                  <i className="bx bx-dollar-circle"></i>
                  <span>{props.t("Batch")}</span>
                </Link>
                <ul className="sub-menu">
                  <li>
                    <Link to="/batches">{props.t("Manage Batches")}</Link>
                  </li>
                </ul>
                {/*<ul className="sub-menu">
                <li>
            ...
            <li>
              <Link to="/#" className="has-arrow">
                <i className="bx bx bx-file"></i>
                <span>{props.t("Reports")}</span>
              </Link>
              <ul className="sub-menu">
                {userRole === "super-admin"  && (
                <li>
                  <Link to="/call-status-report">{props.t("Call Status Report")}</Link>
                </li>
                )}
                { userRole === "normal-admins" && (
                    <li>
                      <Link to="/call-status-report">{props.t("Call Status Report")}</Link>
                    </li>
                )}
                {userRole === "super-admin" && (
                  <li>
                    <Link to="/payment-report">{props.t("Payments")}</Link>
                  </li>
                )}
                {userRole === "super-admin" && (
                  <li>
                    <Link to="/all-commissions-report">{props.t("All Commissions")}</Link>
                  </li>
                )}
                {userRole === "super-admin" && (
                  <li>
                    <Link to="/agent-commissions">{props.t("Agents Commissions")}</Link>
                  </li>
                )}
                {userRole === "agent" && (
                  <li>
                    <Link to="/personal_commissions">{props.t("My Commissions")}</Link>
                  </li>
                )}
                {userRole === "agent" && (
                    <li>
                      <Link to="/call-agent-report">{props.t("Call Status By Agent")}</Link>
                    </li>
                )}
              </ul>
            </li>
            {userRole === "super-admin" && (
              <li>
                ...
                <ul className="sub-menu">
                  <li>
                    <Link to="/commissions">{props.t("Manage Commissions")}</Link>
                  </li>
                </ul>
              </li>
            )}
          ...
          {/*<ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li> s
              <Link to="/#" className="has-arrow">
                ...
                <span>{props.t("Dashboards")}</span>Design & Develop by Themesbrand
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/dashboard">{props.t("Default")}</Link>
